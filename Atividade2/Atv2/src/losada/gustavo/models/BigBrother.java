...
public class BigBrother extends Membro {
    ...
    /**
     * Construtor da classe, recebe id do usuário, nome do usuário, eMail do usuário e sua função na 'sociedade'.
     * @param nome
     * @param eMail
     * @param funcao
     * @param id
     */
    public BigBrother(String nome, String eMail, TiposMembros funcao, int id){
