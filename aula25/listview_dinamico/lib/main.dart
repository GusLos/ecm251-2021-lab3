...
class _MinhaListaDinamicaState extends State<MinhaListaDinamica> {
  final List<Pessoa> pessoas = [Pessoa(nome: "Pikachu", url: "https://assets.pokemon.com/assets/cms2/img/pokedex/full/025.png", subText: "Elétrico"),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Minha Lista Dinamica"),
      ),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: ()async{
          ...
          //Colocar mais usuarios, sem jogar fora
